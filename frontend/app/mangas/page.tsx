...
//     const movies = await getMangas();

//     return (
//         <div className="min-h-screen p-8 md:p-12">
//             <header className="mb-12">
//                 <h1 className="text-4xl font-bold text-white mb-2">Mangás Populares</h1>
//                 <p className="text-gray-400">Explore os títulos mais populares dos mangás</p>
//             </header>
